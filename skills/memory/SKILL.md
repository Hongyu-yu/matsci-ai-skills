...
allowed-tools: Bash(date:*) Bash(jq:*) Bash(printf:*) Bash(mkdir:*) Bash(touch:*) Bash(tail:*) Bash(rg:*) Bash(grep:*) Bash(tac:*)
---
...
- `memory/scripts/memory_write` (reads JSON from stdin; appends 1 JSONL line; prints JSON result)
- `memory/scripts/memory_search` (reads JSON from stdin; searches recent window; prints JSON result)
